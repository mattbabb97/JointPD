...
# Phase 2 -------------------------------------------------------------------------------------------------------------
    ...
    def draw_both_selections(self):
        ...
        if left_selection == 1 and right_selection == 3:
            print("Left Cooperate, Right Cooperate")
            self.left_pellets = 3
...
# Phase 2 -------------------------------------------------------------------------------------------
    ...
    def write(self, file, correct):
        ...
        data = [monkey_group, monkey[0], monkey[1], today, now, session_type, self.block, self.trial_number, self.trial_type[self.trial_within_block], time_taken, correct]
...
writeLn(data_file, ['group', 'monkey_left', 'monkey_right', 'date', 'time', 'session_type', 'block', 'trial_number', 'trial_type', 'response_time', 'correct_or_incorrect'])
